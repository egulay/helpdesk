...
public interface IssueRequestRepository extends PagingAndSortingRepository<IssueRequestModel, Integer> {
    ...
    Page<IssueRequestModel> findAllByRequesterIdAndCreatedBeforeAndCreatedAfter(Integer requesterId, Date createdBefore,
                                                                                Date createdAfter, Pageable pageable);

    Page<IssueRequestModel> findAllByCreatedBeforeAndCreatedAfter(Date createdBefore, Date createdAfter,
                                                                  Pageable pageable);

    Page<IssueRequestModel> findAllByCreatedBeforeAndCreatedAfterAndIsSolved(Date createdBefore, Date createdAfter,
